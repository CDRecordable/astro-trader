    ...
    return (
        <FeaturePage
            ...
            features={[
                ...
                { name: "Coste medio y P&L honestos", detail: "Las compras promedian el coste; las ventas realizan resultado contra ese promedio. Sin trucos de contabilidad creativa." },
                ...
                { name: "Réplica tu cartera real", detail: "¿Ya inviertes? Configura tus posiciones reales por porcentaje y la simulación las compra a precio actual: desde entonces, tu cartera de verdad tiene un espejo medible." },
            ...
            faq={[
                { q: "¿El dinero es de verdad?", a: "No — y por diseño. Son 100.000 € ficticios operando a precios reales de mercado. La app no se conecta a ningún bróker, no puede ejecutar órdenes reales y no toca tu dinero jamás." },
                ...
                { q: "¿Qué es la curva de equity?", a: "El gráfico del valor total de tu cartera (efectivo + posiciones) a lo largo del tiempo, frente a la línea del capital inicial. Se registra un punto por día de visita, así que crece contigo — honesta: empieza el día que empiezas, sin históricos inventados." },
            ]}
            related={[
