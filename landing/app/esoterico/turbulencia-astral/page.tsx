...
export default function Page() {
    return (
        <DimensionPage
            ...
            measurement={[
                { title: "Efemérides calculadas, no fechas escogidas", detail: "Las posiciones planetarias se calculan con astronomy-engine, que da longitudes eclípticas reales para cualquier fecha, de modo que los aspectos emergen del cielo calculado, no de una lista escrita a mano para que cuadre con las crisis." },
            ...
            faq={[
                ...
                { q: "¿El índice predijo 2008 o 2020?", a: "El índice estaba alto alrededor de ambas fechas, y ahí está justo el sesgo de retrospección que la app señala: los aspectos son tan largos que «acertar» una crisis dentro de una ventana de años no tiene mérito estadístico. El test sobre retornos diarios no encuentra poder predictivo distinguible del azar." },
