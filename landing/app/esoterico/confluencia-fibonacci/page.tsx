...
export const metadata: Metadata = {
    ...
    description:
        "Zonas donde un retroceso de Fibonacci coincide en el tiempo con un evento astrológico, y la pregunta que importa: ¿revierte ahí el precio más que en cualquier otro sitio? Retrocesos multi-swing, 170+ eventos y tasa de reversión comparada con su baseline.",
...
export default function Page() {
    return (
        <DimensionPage
            ...
            measurement={[
                { title: "Retrocesos multi-swing", detail: "Los niveles se calculan sobre varios movimientos relevantes del precio simultáneamente, no sobre un único swing elegido a posteriori, que es el truco clásico con el que Fibonacci «siempre acierta»." },
            ...
            faq={[
                ...
                { q: "¿Qué es la tolerancia y por qué se fija antes?", a: "El margen de precio y tiempo dentro del cual se considera que hubo reversión. Con tolerancia elástica todo revierte y la hipótesis es infalsificable; aquí el margen está fijado de antemano, declarado en el panel, y se aplica igual a confluencias y baseline." },
