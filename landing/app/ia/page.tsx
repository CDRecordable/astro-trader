    ...
    return (
        <FeaturePage
            ...
            faq={[
                ...
                { q: "¿Por qué no predice precios?", a: "Porque no puede hacerlo bien y fingir que sí sería vender humo. El prompt se lo prohíbe de forma explícita: su trabajo es el análisis cualitativo verificable — catalizadores, riesgos, narrativa — no la adivinación." },
