...
export default function Page() {
    return (
        <DimensionPage
            ...
            hypothesis="La actividad solar —medida en manchas— sigue ciclos de unos 11 años que afectarían al clima, al ánimo colectivo o incluso a la tecnología, y a través de ellos a la economía y los mercados: máximos solares eufóricos, mínimos deprimidos. Es la versión astro-física del ciclo económico."
            measurement={[
