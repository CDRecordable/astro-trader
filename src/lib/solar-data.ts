...
// Monthly mean total sunspot number (SN_m_tot_V2.0)
// Solar cycles ~11 years: Cycle 23 (1996-2008), Cycle 24 (2008-2019), Cycle 25 (2019-present)

/**
 * Monthly mean total sunspot number from 2000 to 2026.
 * Each entry: [year, month, sunspot_number]
 * SSN = 0 at solar minimum, peaks ~150-250 at solar maximum.
 */
export const MONTHLY_SUNSPOT_DATA: [number, number, number][] = [
    ...
    // 2024 — Approaching Cycle 25 maximum
    [2024, 1, 123.0], [2024, 2, 123.1], [2024, 3, 104.9], [2024, 4, 135.6],
    [2024, 5, 171.7], [2024, 6, 164.2], [2024, 7, 196.5], [2024, 8, 215.5],
    [2024, 9, 161.0], [2024, 10, 180.4], [2024, 11, 182.2], [2024, 12, 165.7],
    // 2025 — Cycle 25 maximum (provisional data + estimates)
    [2025, 1, 139.9], [2025, 2, 126.5], [2025, 3, 131.0], [2025, 4, 145.0],
    [2025, 5, 140.0], [2025, 6, 135.0], [2025, 7, 130.0], [2025, 8, 125.0],
    [2025, 9, 120.0], [2025, 10, 115.0], [2025, 11, 110.0], [2025, 12, 105.0],
    // 2026 — Cycle 25 beginning descent (estimates)
    [2026, 1, 100.0], [2026, 2, 95.0], [2026, 3, 90.0], [2026, 4, 88.0],
];
