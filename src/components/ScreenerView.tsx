...
import {
    ...
    ShieldCheck, Sparkles, AlertTriangle, Table2, ScatterChart, Building2, Layers,
} from "lucide-react";
                ...
                <>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            {/* View toggle: table ↔ scatter. The scatter plots company
                                fundamentals (P/E, growth…), which ETFs don't carry — so
                                it's offered for stocks only. */}
                            <div className="flex items-center gap-1 mr-1" style={{ display: mode === "etf" ? "none" : undefined }}>
                    ...
                    {/* Chart view — cross-metric scatter / quadrant (stocks only) */}
                    {view === "chart" && mode === "stocks" && (
                        <MetricScatter rows={filtered} onSelect={setDetailId} />
                    )}

                    {/* Table (always the view in ETF mode, where the scatter doesn't apply) */}
                    {(view === "table" || mode === "etf") && (
