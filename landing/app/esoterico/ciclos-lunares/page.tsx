    ...
    return (
        <DimensionPage
            ...
            faq={[
                ...
                { q: "¿Sale el mismo resultado que en el paper?", a: "Depende del periodo y el índice: el efecto es débil e inestable, y esa es la conclusión. La app te muestra el resultado sobre los datos cargados, con su p-valor, en lugar de citarte el paper como si fuera ley." },
