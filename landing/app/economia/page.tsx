    ...
    return (
        <FeaturePage
            ...
            features={[
                ...
                { name: "Degradación honesta", detail: "Si una serie oficial deja de publicarse o falla, se muestra como N/D — el panel no inventa ni rompe." },
            ]}
            differentiator={{
                title: "Lectura, no predicción",
                body: "Este panel no pronostica qué hará el BCE ni cuándo bajará tipos la Fed. Hace algo más útil y más honesto: clasifica cada dato frente a su propia historia y te muestra qué sesgo de política monetaria es coherente con ese cuadro. Es el contexto que un análisis fundamental necesita — saber si el viento sopla a favor o en contra — sin disfrazarse de bola de cristal.",
            }}
            faq={[
