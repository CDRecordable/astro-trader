...
export default function Page() {
    return (
        <DimensionPage
            ...
            measurement={[
                { title: "Estrategia configurable de arriba abajo", detail: "Umbral de turbulencia deslizable, filtros opcionales de luna nueva y Mercurio retrógrado, y cuatro activos (S&P 500, Bitcoin, oro, Nasdaq) con décadas de datos diarios reales." },
