...
export default function Page() {
    return (
        <DimensionPage
            ...
            lead="La astrología clásica reparte el mundo entre planetas: Marte rige la guerra, Venus el placer, Mercurio el comercio. Trasladado al mercado: ¿rinde mejor el sector defensa cuando Marte está fuerte? Asignamos regentes, medimos fases y contrastamos con ETFs sectoriales de verdad."
