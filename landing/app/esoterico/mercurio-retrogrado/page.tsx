    ...
    return (
        <DimensionPage
            ...
            faq={[
                ...
                { q: "¿No hay ningún efecto en absoluto?", a: "En nuestros datos, la diferencia entre operar dentro o fuera del retrógrado no supera un test de permutación: es indistinguible de barajar los días al azar. Si en algún periodo concreto aparece una brecha, el panel te muestra su tamaño y su p-valor para que la pongas en contexto." },
                { q: "¿Entonces por qué incluirlo?", a: "Porque es el mito de referencia: auditarlo con datos reales y metodología visible es la mejor vacuna contra el resto del folclore. Y porque hacerlo bien, con efemérides reales y tests que pueden salir negativos, es más interesante que burlarse de él." },
            ]}
        />
    );
}
